                ...
                <div class="teklif pt-100 pb-100">
                    <nav>
                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                            <a href="{{ route('login') }}" class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-login" role="tab" aria-controls="nav-home" aria-selected="true">Kirish</a>
                            <a href="{{ route('register')}}" class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-uye-ol" role="tab" aria-controls="nav-profile" aria-selected="false">Ro'yhatdan otish</a>
                        </div>
                    </nav>
                        ...
                        <div class="tab-pane fade show active" id="nav-login" role="tabpanel" aria-labelledby="nav-home-tab">
                            ...
                            <form action="{{ route('register.store') }}" method="POST">
                                ...
                                <div class="form-group">
                                    <label>Ism</label>
                                    <input name="name" type="text" class="form-control" placeholder="ISM">
                                </div>
                                <div class="form-group">
                                ...
                                <button type="submit" class="btn btn-primary btn-large btn-block">Royhatdan o'tish</button>
                            </form>
                        </div>
